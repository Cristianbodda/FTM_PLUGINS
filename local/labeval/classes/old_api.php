...
class api {
    ...
    public static function get_session_details($sessionid) {
        ...
        // Get ratings
        $session->ratings = $DB->get_records('local_labeval_ratings', 
            ['sessionid' => $sessionid], '', 'behaviorid, rating, notes');
        
        // Get competency scores
        $session->competencyscores = $DB->get_records('local_labeval_comp_scores',
            ['sessionid' => $sessionid], '', 'competencycode, score, maxscore, percentage');
