...
<div class="competency-dashboard">
    ...
    <div class="dashboard-grid">
        ...
        <div class="dashboard-card">
            <h3><span class="card-icon">📄</span> Import Domande XML</h3>
    ...
    <div class="dashboard-grid">
        ...
        <div class="dashboard-card">
            <h3><span class="card-icon">📥</span> Import Standard</h3>
            <p>Import domande XML con interfaccia standard Moodle.</p>
            <a href="import.php?courseid=<?php echo $courseid; ?>" class="btn btn-primary">Import Standard</a>
        </div>
    ...
    <!-- SEZIONE: AUDIT E VERIFICA (NUOVA!) -->
