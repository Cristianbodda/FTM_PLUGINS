...
function convert_word_questions_to_xml($questions, $quiz_name) {
    ...
    foreach ($questions as $q) {
        ...
        // Risposte - formato identico ai template Moodle con CDATA
        foreach ($q['answers'] as $letter => $answer_text) {
            ...
            $xml .= '        <text><![CDATA[<p>' . $answer_escaped . '</p>]]></text>' . "\n";
            $xml .= '        <feedback format="html"><text><![CDATA[<p>' . $feedback . '</p>]]></text></feedback>' . "\n";
            $xml .= '    </answer>' . "\n";
        }
        
        $xml .= '    <correctfeedback format="html"><text><![CDATA[<p>Risposta corretta!</p>]]></text></correctfeedback>' . "\n";
        $xml .= '    <incorrectfeedback format="html"><text><![CDATA[<p>Risposta non corretta.</p>]]></text></incorrectfeedback>' . "\n";
        $xml .= '</question>' . "\n\n";
    }
