 ...
 * 
 * VERSIONE 2.3.1 - Aggiornata 10/01/2026
 * 
 * CORREZIONE v2.3.1:
 * - Test 1.1: Logica corretta con due query separate
 *   1) Conta TUTTE le domande del corso
 *   2) Conta quelle con competenze del framework selezionato
 * 
 * CORREZIONE v2.3:
...
class test_runner {
     ...
     * CORRETTO v2.3.1: Logica corretta - conta TUTTE le domande, poi quelle con competenze del framework
     */
    private function test_1_1_questions_with_competencies() {
        global $DB;
        $start = microtime(true);

        // STEP 1: Conta TUTTE le domande del corso (senza filtro framework)
        $params_total = [];
        $course_where = "";
        ...
        // STEP 2: Conta domande con competenze (del framework selezionato se specificato)
        $params_comp = [];
        $framework_condition = "";
        ...
        $result = (object)[
            ...
            'questions_with_comp' => $questions_with_comp
        ];
