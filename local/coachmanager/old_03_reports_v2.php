...
$radar_labels = json_encode(array_map(fn($a) => $a['info']['nome'], $areas_data));
$radar_quiz_data = json_encode(array_map(fn($a) => $a['quiz_media'] ?? 0, $areas_data));
$radar_autoval_data = json_encode(array_map(fn($a) => $a['autoval_media'] ?? 0, $areas_data));
?>
                ...
                <div class="radar-controls">
                    ...
                    <div class="control-group">
                        ...
                        <select id="filterSector" onchange="updateRadar()">
                            ...
                            <option value="meccanica">Solo Meccanica</option>
                            <option value="automobile">Solo Automobile</option>
                            <option value="automazione">Solo Automazione</option>
                        </select>
                    </div>
                </div>
