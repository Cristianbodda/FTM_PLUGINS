...
function get_quiz_result_for_competency($DB, $studentid, $competencyid, $courseid = 0) {
    // Usa direttamente la tabella corretta
    $sql = "SELECT 
        ...
        <table class="competencies-table" id="competenciesTable">
            ...
            <tbody>
                ...
                <tr class="<?php echo $gapClass == 'negative' ? 'negative-gap' : ''; ?>"
                    ...
                    onclick="window.location.href='selfassessment_detail.php?said=<?php echo $sa->id; ?>&courseid=<?php echo $courseid; ?>&studentid=<?php echo $studentid; ?>'">
                    <td>
                    ...
                    <td>
                        <div class="action-btns" onclick="event.stopPropagation();">
                            <a href="selfassessment_detail.php?said=<?php echo $sa->id; ?>&courseid=<?php echo $courseid; ?>&studentid=<?php echo $studentid; ?>" class="btn-action view" title="Vedi dettaglio">👁️</a>
                        </div>
                    </td>
                </tr>
                <?php endforeach; ?>
