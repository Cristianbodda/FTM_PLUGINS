...
class assessment_manager {
        ...
        foreach ($competencies as $comp) {
            ...
            if ($gap->quiz_percentage !== null && $gap->self_assessment !== null) {
                ...
                if (abs($gap->gap_value) <= 15) {
                    $gap->gap_type = 'aligned'; // Allineato
                } elseif ($gap->gap_value > 15) {
                    $gap->gap_type = 'overconfident'; // Si sopravvaluta
                } else {
                    $gap->gap_type = 'underconfident'; // Si sottovaluta
                }
            ...
            // Estrai area dal codice (es. MECCANICA_CNC_01 -> CNC)
    ...
    /**
     * Recupera autovalutazioni studente
     */
    ...
    /**
     * Recupera autovalutazione per competenza
     */
